...
(define (terms-for-refunds)
  (container
    ...
    (p "NOTE: These terms and conditions only apply when purchases are made on MetaCoders’s website (www.metacoders.org). Purchases of MetaCoders programs made on other websites, like on Fleet Science Center or Del Mar Union websites, have their own Terms and Conditions which supersede these.")))
...
(define (terms-for-late-pickup-fees)
  (container
    ...
    (p "Parents who are late to pick-up their student will be charged a fee. This fee is $15 for every 15 minute period that passes since class has ended. For example, if class ends at 2:55pm, and a parent arrives to pick up their student at 3:10pm (15 minutes late), the card on file will be charged a $15 fee. (And if there is no card on file, an invoice for $15 will be sent.) If class ends at 2:55pm, and a parent arrives to pick up their student at 3:25 (30 minutes late), the parent will be charged $30, etc.")
    ...
    (p "If a parent would prefer for their student to be self-dismissed or dismissed to an extended daycare program on campus, please inform our staff at contact@metacoders.org at the time of registration. Without additional direction from parents regarding their students’ dismissal, we always make student safety a priority, and we will wait with your child until your child is picked up or until we have verbal or written confirmation from the parent to release their child.")))
...
(define (terms-for-students-arriving-to-class)
  (container
    ...
    (p "MetaCoders instructors will always pick-up Kindergarteners directly from their classroom. If your student is a Kindergartener, please indicate their classroom at registration so we know where to pick up your child. However, it is our expectation that students who are in 1st grade or higher grades will arrive to our class without assistance. But we understand that sometimes students forget to go to after-school programs! Therefore, for the first 3 weeks of class, for any students who are not present in the classroom within the first 15 minutes of class, we will call parents to ask if this is a planned absence or if maybe their student forgot to go to class. After the first 3 weeks, students should be able to arrive to class on their own without reminders.")
    (p "To assist our instructors, please let us know at the time of registration if your student normally attends any extended daycare programs after school. This can be helpful for the first 3 weeks when locating students who forget to come to coding class.")))
...
(define (terms-for-student-pickup-after-class)
  (container
    ...
    (p "However, if you have any concerns with your student’s ability to recognize the adult picking them up OR if there are certain adults who are not allowed to pick up your child, please email us at contact@metacoders.org with a list of adults who are allowed or not allowed to pick-up your student. For students who have adults listed as “allowed” or “not allowed”, we will check IDs of adults at pick-up and if a disallowed adult or an adult not listed as allowed tries to pick up your student, we will keep your student with us and try to reach you by phone for confirmation. (Note: in this unlikely situation, if we are unable to reach you by phone, you may incur late pick-up fees - see the late pick-up policy for more information.)")))

(define (terms-for-phonecalls-texts)
  (container
    (h3 "Auto Opt-in to Phonecalls & Non-Automated Texts")
    (p "By providing us with your phone number at registration, you give MetaCoders permission to call and/or text you regarding the program your student is currently enrolled in, as well as reminders about upcoming programs. Parents should expect to receive no more than 2 texts per month about upcoming programs and can expect closer to 0–1 text per month on average. Parents can opt-out of texts at any time by emailing us at contact@metacoders.org.")))

(define (terms-for-media-policy)
  (container
    (h3 "MetaCoders Media Policy")
    (p "When you register for the class, there is an option to provide MetaCoders with photo/video release that allows us to take pictures and video of your child for promotional purposes. It is always your choice whether you provide us with a photo/video release for your child. On rare occasions, San Diego news networks will come film our after-school programs and camps, and only children who have photo/video releases will be recorded for the news.")
    (p "For quality assurance, MetaCoders sometimes video tapes our classes to monitor our instructors. Video recorded for the purpose of quality assurance are not saved or ever used for promotional purposes.")
...
(define (privacy-policy)
  (container
    ...
    (ul
      ...
      (li "We are committed to the environment and will not send paper mailers to you.")
